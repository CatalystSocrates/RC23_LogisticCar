...
#define SCL_OUT_H HAL_GPIO_WritePin(TCS34725_SCL_GPIO_Port, TCS34725_SCL_Pin, GPIO_PIN_SET)
#define SCL_OUT_L HAL_GPIO_WritePin(TCS34725_SCL_GPIO_Port, TCS34725_SCL_Pin, GPIO_PIN_RESET)
#define SDA_OUT_H HAL_GPIO_WritePin(TCS34725_SDA_GPIO_Port, TCS34725_SDA_Pin, GPIO_PIN_SET)
#define SDA_OUT_L HAL_GPIO_WritePin(TCS34725_SDA_GPIO_Port, TCS34725_SDA_Pin, GPIO_PIN_RESET)
#define SDA_IN HAL_GPIO_ReadPin(TCS34725_SDA_GPIO_Port, TCS34725_SDA_Pin)
